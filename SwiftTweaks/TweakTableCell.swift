...
internal final class TweakTableCell: UITableViewCell {
    ...
    @objc private func resetToDefault() {
        ...
        case let .string(_, defaultValue: defaultValue):
            viewData = TweakViewData(type: .string, value: defaultValue, defaultValue: defaultValue, minimum: nil, maximum: nil, stepSize: nil, options: nil)
		...
		case .action:
			assertionFailure("Can't reset an action")
        }
